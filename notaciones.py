class notationConversion():
    ...
    def sinCorchetes(self):
        sinCorchetes = self.notation
        for i in sinCorchetes:
            if '(' in sinCorchetes:
                sinCorchetes.remove('(')
            elif ')' in sinCorchetes:
                sinCorchetes.remove(')')
        return sinCorchetes

    def numero(self, valor):
        if valor == '0' or valor == '1' or valor == '2' or \
                valor == '3' or valor == '4' or valor == '5' or \
                valor == '6' or valor == '7' or valor == '8' or valor == '9':
            return True
        else:
            return False
    ...
    def isBracketsClosed(self, stackLastCharacter, currentCharacter):
        # {}
        if stackLastCharacter == 123 and currentCharacter == 125:
            return True
        # ()
        elif stackLastCharacter == 40 and currentCharacter == 41:
            return True
        # []
        elif stackLastCharacter == 91 and currentCharacter == 93:
            return True
        else:
            return False
